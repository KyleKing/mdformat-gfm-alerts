...
1. Go to your project's page on PyPI: `https://pypi.org/manage/project/mdformat_gfm_alerts/settings/publishing/`
...
1. Add a new Trusted Publisher with these settings:
    - **PyPI Project Name**: `mdformat_gfm_alerts`
    - **Owner**: `kyleking`
    - **Repository name**: `mdformat-gfm-alerts`
...
Use `commitizen` to automatically bump versions (in `pyproject.toml` and `mdformat_gfm_alerts/__init__.py`) and create a commit with tag:
